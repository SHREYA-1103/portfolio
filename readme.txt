...
for background image of perfect size (1920*1080-size of bg image of responsive website) - build desired bg in canva then use that picture


html
# for id (eg: #header)
. for class (eg: .container)
